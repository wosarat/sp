...
public class EuclideanAlgorithm implements Runnable {
    ...
    public EuclideanAlgorithm(Reader reader, Writer writer){
        this.reader=new BufferedReader(reader);
    ...
    public static void main(String[] args) throws IOException {
        new EuclideanAlgorithm(new InputStreamReader(System.in, SYSTEM_ENCODING),new OutputStreamWriter(new BufferedOutputStream(System.out), SYSTEM_ENCODING)).run();
    }
    ...
    private void solve(){
        long n1 = in.nextLong();
        long n2 = in.nextLong();
        long result=euclideanAlgorithm(n1,n2);
        out.println(result);
    }
     ...
     * @return
     */
    private static long euclideanAlgorithm(long n1, long n2) {
