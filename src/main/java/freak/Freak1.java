...
public class Freak1 implements Runnable {
    ...
    public Freak1(Reader reader, Writer writer){
        this.reader=new BufferedReader(reader);
    ...
    public static void main(String[] args) throws IOException {
        new Freak1(new InputStreamReader(System.in, SYSTEM_ENCODING),new OutputStreamWriter(new BufferedOutputStream(System.out), SYSTEM_ENCODING)).run();
    }
