...
public class E implements Runnable {
    ...
    public static void main(String[] args) throws IOException {
        new E(new InputStreamReader(System.in, SYSTEM_ENCODING),new OutputStreamWriter(new BufferedOutputStream(System.out), SYSTEM_ENCODING)).run();
    }
