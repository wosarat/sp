package yandex.algorithm2014.qualification;
//-------------------------------------------------------------------------------------------------------
...
public class F implements Runnable {
    ...
    public F(Reader reader, Writer writer){
        this.reader=new BufferedReader(reader);
    ...
    public static void main(String[] args) throws IOException {
        new F(new InputStreamReader(System.in, SYSTEM_ENCODING),new OutputStreamWriter(new BufferedOutputStream(System.out), SYSTEM_ENCODING)).run();
    }
    ...
    private final static String SMILE_BEGIN="<S>";
    private final static String SMILE_END="</S>";
    private void solve(){
        String message = in.nextLine();
        String result = message.replaceAll("(\\([a-zA-Z]+\\)|[^a-zA-Z0-9 ()]\\))", SMILE_BEGIN+"$0"+SMILE_END);
        out.println(result);
    }
